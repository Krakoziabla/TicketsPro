...
class Terms extends React.Component {
    ...
    render() {
        return (
            <div className='terms-h1'>
                <h1>
                    <div className='terms-h1-h1'>TERMS AND CONDITIONS</div>
                </h1>
                <div className='terms'>
                    <p>
                        1. Scope of validity<br/>
                        The Terms and Conditions apply to legal relations between patrons, on the one hand, and
                        the Berlin City Hall Foundation, on the other, concerning the latter’s artistic establishments
                    ...
                    <p> 2. Schedules and start times<br/>
                        The valid schedules and start times can be found in the official publications of the Berlin
                        City Hall Foundation.
                        The Berlin City Hall Foundation reserves the right to alter the schedules and casts.
                        The Berlin City Hall Foundation accepts no responsibility for information on posters or other
                        publications.
                    </p>
                    <p>
                        3. Entrance fee<br/>
                        The Berlin City Hall Foundation will publish the valid entrance fees and make them known
                        at the ticket offices. Discounts are available to groups of persons with special entitlements,
                        upon presentation of an appropriate certificate at the ticket office. Discounted tickets are
                        valid only with this certificate. If the certificate cannot be produced, the difference between
                    ...
                    <p>
                        ...
                        ‘first come, first served’ basis. There is, however, no right to have orders processed on this
                        basis. Telephone ticket orders will be accepted from the start of the advance sale period.
                        If payment for ordered tickets is not received within the stipulated time limit, these tickets
                        ...
                        reserves the right to legal recourse. Furthermore, the Foundation is entitled to refuse to sell
                    ...
                    <p>
                        ...
                        The Berlin City Hall Foundation reserves the right to alter casts, and cast alterations do not
                        ...
                        refunded.
                        If a performance is cancelled without substitution, the ticket price will be refunded, as long
                        ...
                        these cases, claims for refunds are valid only if the tickets are presented or sent to Patron
                    ...
                    <p>
                        6. Lost tickets<br/>
                        If a patron loses his or her ticket, he or she will be provided with a replacement ticket at the
                    ...
                    <p>
                        ...
                        returned only if the patron gives a believable account of his or her entitlement to the items.
                    ...
                    <p>
                        ...
                        performance venues. It is not permitted to offer tickets for sale in the ticket office halls or
                        ...
                        the difference between the paid ticket price and the ticket price for the seat occupied, send
                    ...
                    <p>
                        11. Image and sound recording<br/>
                    ...
                    <p>
                        12. Liability<br/>
                        The Berlin City Hall Foundation, its representatives and its employees accept no liability for
                    ...
                    <p>
                        15. Concluding clause<br/>
                        Should any stipulation of these General Terms and Conditions be invalid, the legal validity of
                ...
                <div className='term-return'>
                    <Button type="submit" variant="secondary">
                        <div className='term-return-1'>RETURN</div>
                    </Button>
                </div>
            </div>
    )
